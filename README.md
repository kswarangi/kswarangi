...
Working with MCP servers to orchestrate tool-enabled AI workflows

Developing an automated mailing system powered by LLMs for personalized, scalable outreach

Optimizing semantic & hybrid search pipelines and retrieval strategies
...
RAG, MCP, and LLM system implementations

Scalable ML pipelines and backend services

Experiments focused on evaluation, reliability, and production readiness
